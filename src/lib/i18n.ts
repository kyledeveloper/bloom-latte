...
const zh = {
  ...
  quickTagsHint: "点选快速填入或取消",
  equipmentAndCup: "器具与杯型",
  techniqueAndFoam: "手法复盘",
  beansSuggestions: "常用豆种",
  grindSuggestions: "常用刻度",
  manageTags: "管理标签",
  manageTagsTitle: "管理快捷标签",
  manageTagsDesc: "添加、修改或删除常用器具、杯型与手法关键词",
  customTag: "自定义",
  addTag: "添加",
  addTagPlaceholder: "输入新标签名称",
  editTag: "修改",
  deleteTag: "删除",
  resetDefaultTags: "恢复默认",
  resetTagsConfirm: "确定要恢复为默认标签吗？自定义标签将被重置。",
  tagAlreadyExists: "该标签已存在",
  done: "完成",
  save: "保存",
  cancel: "取消",
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  scanToExplore: "Scan to explore",
  shareWebsite: "Website link",
  ...
  quickTagsHint: "Tap to toggle into notes",
  equipmentAndCup: "Equipment & Cup",
  techniqueAndFoam: "Technique & Diagnostics",
  beansSuggestions: "Common beans",
  grindSuggestions: "Common grinds",
  manageTags: "Manage tags",
  manageTagsTitle: "Manage Quick Tags",
  manageTagsDesc: "Add, edit, or remove custom equipment, cups, and diagnostic tags",
  customTag: "Custom",
  addTag: "Add",
  addTagPlaceholder: "Enter new tag name",
  editTag: "Edit",
  deleteTag: "Delete",
  resetDefaultTags: "Reset to defaults",
  resetTagsConfirm: "Reset all tags to default? Custom tags and edits will be cleared.",
